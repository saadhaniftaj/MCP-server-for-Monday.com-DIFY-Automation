...
console.log('🔓 Dify-Cleanup-Fixed Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Cleanup-Fixed Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - return empty response for notifications
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - returning empty response');
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Cleanup-Fixed Server running on port ${PORT}`);
