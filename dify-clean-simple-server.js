...
console.log('🔓 Dify-Clean-Simple Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Clean-Simple Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - simple empty response
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Clean-Simple Server running on port ${PORT}`);
