...
console.log('🔓 Simple Dify MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Simple Dify MCP Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - return minimal JSON response
...
app.listen(PORT, () => {
  console.log(`🚀 Simple Dify MCP Server running on port ${PORT}`);
