...
console.log('🔓 Dify-No-Cleanup Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-No-Cleanup Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-No-Cleanup Server running on port ${PORT}`);
