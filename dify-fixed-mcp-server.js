...
console.log('🔓 Dify-Fixed MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Fixed MCP Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - don't return result for notifications
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Fixed MCP Server running on port ${PORT}`);
