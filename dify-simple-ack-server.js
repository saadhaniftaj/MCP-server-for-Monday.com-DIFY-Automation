...
console.log('🔓 Dify-Simple-Ack Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Simple-Ack Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - send a simple acknowledgment
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending simple acknowledgment');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: {
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Simple-Ack Server running on port ${PORT}`);
