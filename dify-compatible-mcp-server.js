...
console.log('🔓 Dify-Compatible MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Compatible MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Compatible MCP Server running on port ${PORT}`);
