...
console.log('🔓 Dify-Ultra-Simple MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Ultra-Simple MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Ultra-Simple MCP Server running on port ${PORT}`);
