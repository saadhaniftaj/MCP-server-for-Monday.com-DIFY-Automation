...
console.log('🔓 Dify-Empty-Object Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Empty-Object Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - empty object result
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending empty object result');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: {}
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Empty-Object Server running on port ${PORT}`);
