...
app.get('/health', (req, res) => {
  res.json({
    status: "ok",
    message: "Dify-Final-Railway Server is running",
    auth: "NO AUTHENTICATION REQUIRED"
  });
});

// Main MCP endpoint - Final Railway optimized
app.post('/', (req, res) => {
  ...
  // Handle different methods - Final Railway optimized
  switch (method) {
    case 'initialize':
      return res.json({
        jsonrpc: "2.0",
    ...
    case 'notifications/initialized':
      // NO RESPONSE for notifications - prevents cleanup errors
      return;
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Dify-Final-Railway Server running on port ${PORT}`);
  console.log(`⚡ Final Railway optimized - NO response for notifications`);
