...
app.post('/', (req, res) => {
  ...
  switch (method) {
    ...
    case 'notifications/initialized':
      // 🚨 HYBRID APPROACH: HTTP 204 No Content - prevents timeouts, avoids cleanup errors
      console.log('🚨 HYBRID: Sending HTTP 204 for notifications/initialized');
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Dify-Hybrid Server running on port ${PORT}`);
  console.log(`⚡ HYBRID: HTTP 204 for notifications`);
  console.log(`🔧 Protocol version: 2025-03-26`);
  console.log(`🔗 Health check: http://localhost:${PORT}/health`);
  console.log(`🌐 CORS enabled for Dify.ai domains`);
  console.log(`📝 Note: This prevents timeouts while avoiding cleanup errors`);
}); 