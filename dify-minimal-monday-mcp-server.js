...
console.log('🔓 Dify-Minimal Monday.com MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Minimal Monday.com MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Minimal Monday.com MCP Server running on port ${PORT}`);
