...
console.log('🔓 Dify-Object-Result Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Object-Result Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - send result as object
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending result as object');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: {
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Object-Result Server running on port ${PORT}`);
