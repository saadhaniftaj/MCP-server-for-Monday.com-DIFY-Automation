...
app.get('/health', (req, res) => {
  res.json({
    status: "ok",
    message: "Dify-Fast Server is running",
...
app.post('/', (req, res) => {
  ...
  // Handle different methods - immediate responses
  switch (method) {
    case 'initialize':
      return res.json({
        jsonrpc: "2.0",
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 Dify-Fast Server running on port ${PORT}`);
  console.log(`⚡ Optimized for speed - no logging, immediate responses`);
