...
echo "🧪 Testing Railway-Compatible n8n MCP Integration"
echo "================================================"
...
# Test webhook URL
WEBHOOK_URL="http://localhost:5678/webhook/mcp-railway"

echo ""
echo "🔧 Testing Railway-Compatible MCP Integration..."
...
curl -X POST $WEBHOOK_URL \
  ...
  -d '{"message": "change email of task 1 to railway-test@example.com"}' | jq '.'
...
echo ""
echo "🎉 Railway-compatible workflow tests completed!"
echo ""
echo "📋 Next steps:"
echo "1. Import railway-compatible-n8n-workflow.json into n8n"
