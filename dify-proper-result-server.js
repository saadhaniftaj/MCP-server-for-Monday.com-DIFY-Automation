...
console.log('🔓 Dify-Proper-Result Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Proper-Result Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - send proper result field
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending proper result field');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: {
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Proper-Result Server running on port ${PORT}`);
