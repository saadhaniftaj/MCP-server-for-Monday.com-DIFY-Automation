...
console.log('🔓 Dify-No-Result Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-No-Result Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - NO RESPONSE BODY (correct for notifications)
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending no response body');
    console.log('📤 Sending HTTP 200 with no body (correct for notifications)');
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-No-Result Server running on port ${PORT}`);
