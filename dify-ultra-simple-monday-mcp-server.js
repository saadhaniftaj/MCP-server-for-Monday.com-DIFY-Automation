...
console.log('🔓 Dify-Ultra-Simple Monday.com MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Ultra-Simple Monday.com MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Ultra-Simple Monday.com MCP Server running on port ${PORT}`);
