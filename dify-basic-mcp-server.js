...
console.log('🔓 Dify-Basic MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Basic MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Basic MCP Server running on port ${PORT}`);
