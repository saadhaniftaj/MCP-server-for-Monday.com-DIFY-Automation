...
echo "🧪 Testing Working n8n MCP Integration"
echo "====================================="
...
echo ""
echo "🔧 Testing Working MCP Integration..."
...
curl -X POST $WEBHOOK_URL \
  ...
  -d '{"message": "change email of task 1 to working-test@example.com"}' | jq '.'
...
echo ""
echo "🎉 Working workflow tests completed!"
echo ""
echo "📋 Next steps:"
echo "1. Import working-n8n-workflow.json into n8n"
