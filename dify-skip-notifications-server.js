...
console.log('🔓 Dify-Skip-Notifications Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Skip-Notifications Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - completely skip this method
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - SKIPPING THIS METHOD');
    // Don't send any response at all - just ignore it
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Skip-Notifications Server running on port ${PORT}`);
