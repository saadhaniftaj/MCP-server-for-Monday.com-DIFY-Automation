...
console.log('🔓 Dify-Final-MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Final-MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Final-MCP Server running on port ${PORT}`);
