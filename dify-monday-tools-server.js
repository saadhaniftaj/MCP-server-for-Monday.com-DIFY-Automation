...
console.log('🔓 Dify-Monday-Tools Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Monday-Tools Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Monday-Tools Server running on port ${PORT}`);
