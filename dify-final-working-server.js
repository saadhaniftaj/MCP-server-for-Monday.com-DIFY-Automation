...
console.log('🔓 Dify-Final-Working Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Final-Working Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - send a minimal valid JSON response
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending minimal valid JSON response');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: {}
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Final-Working Server running on port ${PORT}`);
