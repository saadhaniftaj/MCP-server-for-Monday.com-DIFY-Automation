...
console.log('🔓 Dify-Notification-Fixed Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Notification-Fixed Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - NO result field for notifications
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized');
    // For notifications, we don't send a response body at all
    console.log('📤 Sending empty response for notification');
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Notification-Fixed Server running on port ${PORT}`);
