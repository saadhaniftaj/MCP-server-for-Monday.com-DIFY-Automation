...
console.log('🔓 Ultra Simple MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Ultra Simple MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Ultra Simple MCP Server running on port ${PORT}`);
