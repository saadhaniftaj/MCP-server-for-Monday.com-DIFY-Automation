...
console.log('🔓 Dify-JSON-Fixed Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-JSON-Fixed Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - return proper JSON response
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-JSON-Fixed Server running on port ${PORT}`);
