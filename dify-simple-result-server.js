...
console.log('🔓 Dify-Simple-Result Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Simple-Result Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - send a simple result
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending simple result');
    const response = {
      jsonrpc: '2.0',
      id: id || 0,
      result: "ok"
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Simple-Result Server running on port ${PORT}`);
