...
console.log('🔓 Dify-Ultimate MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Ultimate MCP Server is running',
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Ultimate MCP Server running on port ${PORT}`);
