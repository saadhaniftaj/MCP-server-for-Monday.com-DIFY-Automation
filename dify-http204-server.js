...
console.log('🔓 Dify-HTTP204 Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-HTTP204 Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - HTTP 204 No Content (correct for notifications)
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending HTTP 204 No Content');
    console.log('📤 Sending HTTP 204 No Content (correct for notifications)');
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-HTTP204 Server running on port ${PORT}`);
