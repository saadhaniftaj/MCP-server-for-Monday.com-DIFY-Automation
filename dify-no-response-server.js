...
console.log('🔓 Dify-No-Response Server - NO AUTHENTICATION REQUIRED');
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - NO RESPONSE AT ALL
  if (method === 'notifications/initialized') {
    console.log('📤 Handling notifications/initialized - sending NO response');
    // Don't send any response at all
