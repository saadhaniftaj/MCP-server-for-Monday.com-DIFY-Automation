...
console.log('🔓 MCP Spec Compliant Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'MCP Spec Compliant Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - return empty object result
...
app.listen(PORT, () => {
  console.log(`🚀 MCP Spec Compliant Server running on port ${PORT}`);
