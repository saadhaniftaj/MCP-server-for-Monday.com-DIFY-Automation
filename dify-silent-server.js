...
// Middleware - optimized for silent notifications
app.use(cors());
...
app.get('/health', (req, res) => {
  res.json({
    status: "ok",
    message: "Dify-Silent Server is running",
    auth: "NO AUTHENTICATION REQUIRED"
  });
});

// Main MCP endpoint - Silent notifications
app.post('/', (req, res) => {
  ...
  // Handle different methods - Silent notifications
  switch (method) {
    case 'initialize':
      return res.json({
        jsonrpc: "2.0",
