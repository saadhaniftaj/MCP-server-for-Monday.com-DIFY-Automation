...
console.log('🔓 Dify-Final-Working-MCP Server - NO AUTHENTICATION REQUIRED');

// Health check
app.get('/health', (req, res) => {
  res.json({
    status: 'ok',
    message: 'Dify-Final-Working-MCP Server is running',
...
app.post('/', (req, res) => {
  ...
  // Handle notifications/initialized - return minimal valid JSON
...
app.listen(PORT, () => {
  console.log(`🚀 Dify-Final-Working-MCP Server running on port ${PORT}`);
